...
```
        ...
        ┌┼┐                                                                                                                |        |                           
         │                                  ┌───────┐                     ┌──────────┐           ┌─────────────┐           |        |          ┌───────────────┐
        ┌┴┐                                 │Handler│                     │Repository│           │InMemoryCache│           '-.____.-'          │InMemoryStorage│
      Client                                └───┬───┘                     └─────┬────┘           └──────┬──────┘           Postgres            └───────┬───────┘
         │              𝟏 /start               ┌┴┐                              │                       │                      │                       │        
         │────────────────────────────────────>│ │                              │                       │                      │                       │        
         │                                     │ │                              │                       │                      │                       │        
         ...
         │                                     │ │ <───┘                        │                       │                      │                       │        
         │                                     │ │                              │                       │                      │                       │        
         │                                     │ │    𝟑 GetUser(telegramID)    ┌┴┐                      │                      │                       │        
         │                                     │ │ ───────────────────────────>│ │                      │                      │                       │        
         │                                     │ │                             │ │                      │                      │                       │        
         │                                     │ │                             │ │𝟒 SELECT * FROM users WHERE telegram_id = ? ┌┴┐                      │        
         │                                     │ │                             │ │ ──────────────────────────────────────────>│ │                      │        
         │                                     │ │                             │ │                      │                     └┬┘                      │        
         │                                     │ │                             │ │                   𝟓 User                    │                       │        
         │                                     │ │                             │ │ <─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─│                       │        
         ...
         │                                     │ │ <─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ │                       │                      │                       │        
         │                                     └┬┘                              │                       │                      │                       │        
         │𝟕 showRequestAdditionalData(context)  │                               │                       │                      │                       │        
         │<─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─│                               │                       │                      │                       │        
         │                                      │                               │                       │                      │                       │        
         │ 𝟖 Заполняет дополнительные данные   ┌┴┐                              │                       │                      │                       │        
         │────────────────────────────────────>│ │                              │                       │                      │                       │        
         │                                     │ │                              │                       │                      │                       │        
         │                                     │ │𝟗 CreateRequest(requestData) ┌┴┐                      │                      │                       │        
         │                                     │ │ ───────────────────────────>│ │                      │                      │                       │        
         │                                     │ │                             │ │                      │                      │                       │        
         │                                     │ │                             │ │       𝟏𝟎 INSERT INTO requests (...)        ┌┴┐                      │        
         │                                     │ │                             │ │ ──────────────────────────────────────────>│ │                      │        
         │                                     │ │                             │ │                      │                     └┬┘                      │        
         │                                     │ │                             │ │                𝟏𝟏 RequestID                 │                       │        
         │                                     │ │                             │ │ <─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─│                       │        
         │                                     │ │                             │ │                      │                      │                       │        
         │                                     │ │                             │ │                      𝟏𝟐 CreateEvent(request)│                      ┌┴┐       
         │                                     │ │                             │ │ ──────────────────────────────────────────────────────────────────>│ │       
         │                                     │ │                             │ │                      │                      │                      └┬┘       
         │                                     │ │                             │ │                  𝟏𝟑 File (календарное приглашение)                  │        
         │                                     │ │                             │ │ <─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─│        
         │                                     │ │                             └┬┘                      │                      │                       │        
         │                                     │ │      𝟏𝟒 Request + File       │                       │                      │                       │        
         │                                     │ │ <─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ │                       │                      │                       │        
         ...
         │<─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─│                               │                       │                      │                       │        
      Client                                ┌───┴───┐                     ┌─────┴────┐           ┌──────┴──────┐           Postgres            ┌───────┴───────┐
        ┌─┐                                 │Handler│                     │Repository│           │InMemoryCache│            ,.-^^-._           │InMemoryStorage│
        ║"│                                 └───────┘                     └──────────┘           └─────────────┘           |-.____.-|          └───────────────┘
        └┬┘                                                                                                                |        |                           
        ┌┼┐                                                                                                                |        |                           
         │                                                                                                                 |        |                           
